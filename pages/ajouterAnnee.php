...
require '../codePHP/ajouterAnnee.php';
...
<div class="container" style="background-color: #FA8072;">
 ...
 <script>    
 	setTimeout(function(){
    window.location = "ajouterAnnee.php";}, 4000);
 </script>
...
<div class="container" style="background-color: #32CD32;">
 ...
 <script>    
   setTimeout(function(){
    window.location = "listeAnnee.php";}, 4000);
 </script>
<?php } ?>
...
<label>Nom</label>
<input type="text" name="nom_annee" autocomplete="off" required class="form-control">
</div>
</div>
