...
<td><a href="editerAnnee.php?id_annee_scolaire=<?php echo $resultat['id_annee_scolaire']; ?>"><input type="submit" class="btn btn-primary" value="Editer"></a></td>
<td><a href="ajouterAnnee.php"><input type="submit" class="btn btn-success" value="Nouveau"></a></td>
</tr>
<?php } ?>
