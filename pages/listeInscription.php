...
<div class="col">
<h3 class="page-title">liste des élèves inscris !</h3>
</div>
</div>
</div>
...
<input type="number" maxlength="12"  name="id_eleve" class="form-control">
</div>
</div>
...
<label>Annee scolaire</label>
   ...
   <input type="text"  name="id_annee_scolaire" maxlength="12" class="form-control">
...
<div class="form-group">
<label>classe</label>
<input type="text" maxlength="12" name="id_classe" class="form-control">
</div>
</div>
...
<td>
   <a href="editerInscription.php?id_inscription=<?php echo $resultat['id_inscription']; ?>" onclick="return confirm('Voulez-vous vraiment modifier ce élément?');">Editer</a>
</td>
<td>
   <a href="reinscrire.php?id_eleve=<?php echo $resultat['id_eleve']; ?>" onclick="return confirm('Voulez-vous vraiment inscrire ce élève?');">Reinscrire</a>
</td>
<td>
   <a href="detailInsccription.php?id_inscription=<?php echo $resultat['id_inscription']; ?>" onclick="return confirm('Voulez-vous vraiment voir la fiche de cet élève?');">Fiche</a>
</td>
</tr>
<?php } ?>
