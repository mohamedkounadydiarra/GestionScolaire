...
<input type="number" maxlength="12" required name="id_eleve" class="form-control">
</div>
</div>
...
<input type="number" maxlength="12" required name="frais_inscription" class="form-control">
</div>
</div>
